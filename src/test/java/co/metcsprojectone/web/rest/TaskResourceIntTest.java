...
import co.metcsprojectone.repository.TaskRepository;
import co.metcsprojectone.repository.search.TaskSearchRepository;
...
import static co.metcsprojectone.web.rest.TestUtil.sameInstant;
...
public class TaskResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_TARGETDATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_TARGETDATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getTargetdate()).isEqualTo(DEFAULT_TARGETDATE);
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].targetdate").value(hasItem(sameInstant(DEFAULT_TARGETDATE))));
    }
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.targetdate").value(sameInstant(DEFAULT_TARGETDATE)));
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getTargetdate()).isEqualTo(UPDATED_TARGETDATE);
